...
{
    public class Tipos_HabitacionesAplicacion : ITipos_HabitacionesAplicacion
    {
        private IConexion? IConexion = null;

        public Tipos_HabitacionesAplicacion(IConexion iConexion) => this.IConexion = iConexion;
