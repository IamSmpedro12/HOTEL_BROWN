...
{
    public class Habitaciones_TiposAplicacion : IHabitaciones_TiposAplicacion
    {
        private IConexion? IConexion = null;

        public Habitaciones_TiposAplicacion(IConexion iConexion) => this.IConexion = iConexion;
